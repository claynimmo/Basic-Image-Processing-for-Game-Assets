...
public class InvertImageTest{
    ...
    public void ImageIsEqual(){
        ...
        string newFilePath = Path.Combine(AppContext.BaseDirectory, TestingUtils.outputsPath,"image-inverted.png");
        string compareFilePath = Path.Combine(AppContext.BaseDirectory, TestingUtils.testOutputsPath,"image-inverted.png");
